...
export class Platforms {
    ...
    get randomData() {
        ...
        const offset =
            ...
            Math.round(
                Math.random() *
                    (this.ranges.offset.max - this.ranges.offset.min)
            )
        data.x =
            this.current.container.x + this.current.container.width + offset
        data.cols =
        ...
        data.rows =
            ...
            Math.round(
                Math.random() * (this.ranges.rows.max - this.ranges.rows.min)
            )
